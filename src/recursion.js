...
var sum = function(array) {
  ...
  return 0;
  // I like this way better but we couldn't mutate original array.
  // if (array.length) {
  //   var val = array.pop();
  //   return val + sum(array);
  // }
  // return 0;
};
...
//    return neg ? -x : x;  
//  }
//   return neg ? -modulo(x - y, y):
//                     modulo(x - y, y);
  
// };


  // var extra = Math.floor(x / y);
  // return x - (extra * y);
...
var createArray = function(str) {
  ...
  if (str.length === 1) {
    ...
    return char.concat(createArray(str.slice(1)));
  }
};
